         ...
         if (showLevels) {
             ...
             for (ushort i = 0; i < levels.allLevels.Length; i++) {
                 ...
                 if (levels.allLevels [i].showBoard) {
                     ...
                     for (int x = -1; x < levels.allLevels [i].column; x++) {
                         ...
                         for (int y = -1; y < levels.allLevels [i].rows; y++) {
                             ...
                             if (x >= 0 && y >= 0) {
                                 ...
                                 levels.allLevels [i].board [x + y * 4] = (BlockColors)EditorGUILayout.EnumPopup (levels.allLevels [i].board [x + y * 5], enumStyle);
                                 EditorGUILayout.EndHorizontal ();
                             }
                         }
